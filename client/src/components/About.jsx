    ...
    <section id="about" className="min-h-screen flex items-center justify-center px-4 py-20">
      <div className="max-w-4xl">
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-purple-500/20">
          ...
          <p className="text-lg text-gray-300 mb-6">
            My expertise lies in building complete solutions from database design
            to intuitive front-end interfaces. I&apos;m committed to writing clean,
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            {['5+ Projects', '2+ Years Exp', 'Full-Stack', 'API Design'].map((item, i) => (
              <div
                key={i}
                className="text-center p-4 bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-lg border border-purple-500/20"
              >
